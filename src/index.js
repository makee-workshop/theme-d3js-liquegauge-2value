...
app.ContainerView2 = Backbone.View.extend({
  el: '#gauge2',
  ...
  update: function() {
    ...
    if (y < 30) {
      loadLiquidFillGauge("fillgauge2", y, this.config1);
    } else if (y >= 30 && y < 50) {
      loadLiquidFillGauge("fillgauge2", y, this.config2);
    } else if (y >= 50 && y < 90) {
      loadLiquidFillGauge("fillgauge2", y /*, this.config3 */);
    } else if (y >= 90 && y <= 100) {
      loadLiquidFillGauge("fillgauge2", y, this.config4);
    } else {
      loadLiquidFillGauge("fillgauge2", y, this.config5);
    }
  }
});
...
app.AppRoutes = Backbone.Router.extend({
  ...
  appByName: function(name) {
    ...
    app.containerView2 = new app.ContainerView2();
    app.containerView2.syncUp(name);
  }
});
